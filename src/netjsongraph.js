    ...
    d3.netJsonGraph = function (url, opts) {
        ...
        opts = d3._extend({
            ...
            onClickNode: function (n) {
                console.log(nodesTargetMap[n.id]);
                ...
                /**
                 * Create the div——adjNodeDiv which includes the title and content
                 **/
                ...
                adjNodeController.className = 'njg-adjacent-node-controller';
                adjNodeController.open = true;//Record the status
                let adjArray = nodesTargetMap[n.id],//Get all adjacent nodes
                ...
                adjNodeController.onclick = function () {//Control the display of the adjNodeList
                    if (this.open === false) {
                        adjNodeController.innerHTML = "<span><b>adjacent node</b></span><div class='regular-triangle'></div>";
                        this.open = true;
                        adjNodeList.style.display = 'block';
