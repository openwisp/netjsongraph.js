...
(function () {
    ...
    d3.netJsonGraph = function(url, opts) {
         ...
         * @param  {function}    onInit                         Personalized function before netJsonGraph load
         * @param  {function}    onLoad                         Personalized function after netJsonGraph load
         * @param  {function}    onEnd                          Personalized function when netJsonGraph animations are done
        ...
        opts = d3._extend({
             ...
             * @name onInit
             *
             * Run personalized function before netJsonGraph load
             ...
             * @name onLoad
             *
             * Run personalized function after netJsonGraph load
             * @param  {string|object}  url     The netJson remote url or object
             * @param  {object}         opts    The object of passed arguments
             * @return {function}
             */
        ...
        processJson = function(graph) {
            ...
            opts.executionTime = {};
            opts.executionTime.start = new Date().getTime();
            var attrs = [
                "protocol",
                "version",
                "revision",
            ...
            .on("end", function(){
                opts.executionTime.end = new Date().getTime();
                opts.executionTime.total = opts.executionTime.end - opts.executionTime.start;
