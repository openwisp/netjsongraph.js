...
- Treat `lib/`, `dist/`, and their built CSS, JavaScript, and assets as generated artifacts. Make source changes under `src/`, `public/`, or other tracked build inputs, not in built outputs or dependency directories such as `node_modules/`.
